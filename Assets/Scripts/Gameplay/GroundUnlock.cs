...
public class GroundUnlock : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(other.CompareTag("Player"))
        {
            ...
            HudManager.instance.showMessage("Clic droit pour débloquer les sols");
        }
    }
    ...
    private void Update()
    {
        if(playerInRange && Input.GetMouseButtonDown(1))
        {
            ...
            else
            {
                ...
                HudManager.instance.showTimedMessage("Nettoyez touts les tas de terre pour activer l'objet !");
                HudManager.instance.RemoveMessageAfterDelay(2f);
            }
        }
    }
